...
Namespace TeamCollect
    Public Class AgenceController
        ...
        Function Index(sortOrder As String, currentFilter As String, searchString As String, page As Integer?) As ActionResult
            ...
            Dim entities = From e In db.Agences.OfType(Of Agence)().ToList
        ...
        Function Create() As ActionResult
            Dim scteVM As New AgenceViewModel
        ...
        <LocalizedAuthorize(Roles:="ADMINISTRATEUR")>
        Function Create(ByVal societeVM As AgenceViewModel) As ActionResult
            If ModelState.IsValid Then
                Dim scte = From e In db.Societes.OfType(Of Societe).ToList

                societeVM.Etat = False
                societeVM.SocieteId = scte.First.Id
                societeVM.DateCreation = Now.Date
                Dim Ag = societeVM.getEntity()
                Ag.UserId = getCurrentUser.Id
        ...
        Function Edit(ByVal id As Long?) As ActionResult
            If IsNothing(id) Then
                Return New HttpStatusCodeResult(HttpStatusCode.BadRequest)
            End If
            Dim societe As Agence = db.Agences.Find(id)
            If IsNothing(societe) Then
                Return HttpNotFound()
            End If
            Dim SocieteVM = New AgenceViewModel(societe)
            Return View(SocieteVM)
        End Function
        ...
        <ValidateAntiForgeryToken()>
        <LocalizedAuthorize(Roles:="ADMINISTRATEUR")>
        Function Edit(ByVal societe As AgenceViewModel) As ActionResult
            If ModelState.IsValid Then
