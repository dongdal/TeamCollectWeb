...
Namespace Migrations
    ...
    Public NotInheritable Partial Class Add_Table_CompteurImpression
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(Add_Table_CompteurImpression))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201912300754013_Add_Table_CompteurImpression"
            End Get
        End Property
