        ...
        <div class="panel panel-pattern toggle panelMove panelRefresh">
            ...
            <div class="panel-body pt0 pb0">
                <div id="wizard" class="bwizard">
                    @Using (Html.BeginForm("Create", "SecteurActivite", FormMethod.Post, New With {.role = "form"}))
                        ...
                        @<div class="box box-warning">
                            <div class="box-header with-border">
                                ...
                                <div class="box-footer" style="text-align:center">
                                    ...
                                    @Html.ActionLink("Retour", "Index", "SecteurActivite", Nothing, New With {.class = "btn btn-default btn-sm"})
                                </div>
                                <br />
                            </div>
                        </div>
