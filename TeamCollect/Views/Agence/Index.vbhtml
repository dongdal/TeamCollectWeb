@modelType PagedList.IPagedList(Of Agence)
...
<div class="contentwrapper">
    ...
    <div class="heading">
        ...
        <h3 style="color:#353535">
            <i class="fa fa-archive"></i>Vos Agences
        </h3>
        <div style="float:right; color:black">
            <a href="@Url.Action("Create")" class="btn btn-primary mr5 mb10" style="margin-top: 5px; color:#353535">
                <i class="glyphicon glyphicon-plus mr5"></i> Enregistrer une agence dans le système
            </a>
        </div>
    ...
    <br />
    <div class="row">
        @Using (Html.BeginForm("Index", "Agence", FormMethod.Get, New With {.class = "form-inline", .role = "form"}))
