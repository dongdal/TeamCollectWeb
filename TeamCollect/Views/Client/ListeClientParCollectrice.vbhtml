...
<div class="contentwrapper">
    ...
    <div class="heading">
        ...
        <h3 style="color:#353535">
            <i class="fa fa-archive"></i> Liste des clients par collectrice et par période
        </h3>
    </div>
    <!-- End  / heading-->
    <!-- Start .row -->
...
<script>
    $('#lnkReport').on('click', function () {
        ...
        if (CollecteurId == null || CollecteurId == "") {
            alert("Merci de bien vouloir sélectionner une collectrice.");
        } else {
            $('#ifrReport').attr('src', '@Url.Content("~/Report/NewReport.aspx")?DateDebut=' + DateDebut + '&DateFin=' + DateFin + '&AgenceId=' + AgenceId + '&CollecteurId=' + CollecteurId + '&type=ListeClientParCollectrice')
        }
    });
