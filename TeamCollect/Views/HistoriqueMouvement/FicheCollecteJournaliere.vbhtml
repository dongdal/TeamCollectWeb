  ...
  <div class="contentwrapper">
        ...
        <div class="heading">
            ...
            <h3 style="color:#353535">
                <i class="fa fa-archive"></i> Fiche de Collecte journalière
            </h3>
        </div>
        <!-- End  / heading-->
        <!-- Start .row -->
                    ...
                    <fieldset>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Caisse du collecteur </label>
                                <label style="color: #fdcd23"> @Html.ValidationMessageFor(Function(model) model.JournalCaisseId) </label>
                                @Html.DropDownListFor(Function(model) model.JournalCaisseId,
               New SelectList(Model.IDsJournalCaisse, "Value", "Text"), "Selectionnez une caisse", New With {.class = "form-control select2"})
                            </div>
                        </div>
                        <div class="col-md-2">
                            <br />
...
<script>
    $('#lnkReport').on('click', function () {
        ...
        var JournalCaisseId = $('#JournalCaisseId').val();
        $('#ifrReport').attr('src', '@Url.Content("~/Report/NewReport.aspx")?JournalCaisseId=' + JournalCaisseId +'&type=FicheCollecte')
