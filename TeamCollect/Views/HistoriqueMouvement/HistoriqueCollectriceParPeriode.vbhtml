...
<div class="contentwrapper">
    ...
    <div class="heading">
        ...
        <h3 style="color:#353535">
            <i class="fa fa-archive"></i> Etat caisse collectrice
        </h3>
    </div>
    <!-- End  / heading-->
    <!-- Start .row -->
...
<script>
    $('#lnkReport').on('click', function () {
        ...
        if (CollecteurId == null || CollecteurId == "") {
            ...
            $('#ifrReport').attr('src', '@Url.Content("~/Report/NewReport.aspx")?DateDebut=' + DateDebut + '&DateFin=' + DateFin + '&CollecteurId=' + CollecteurId + '&type=HistoriqueCollectriceParPeriode')
        }
    });
