  ...
  <div class="contentwrapper">
        ...
        <div class="heading">
            ...
            <h3 style="color:#353535">
                <i class="fa fa-archive"></i> Historique Client
            </h3>
        </div>
        <!-- End  / heading-->
        <!-- Start .row -->
                    ...
                    <fieldset>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <label style="color: #fdcd23"> @Html.ValidationMessageFor(Function(model) model.ClientId) </label>
...
<script>
    $('#lnkReport').on('click', function () {
            ...
            var IdColt = $('#ClientId').val();
             $('#ifrReport').attr('src', '@Url.Content("~/Report/NewReport.aspx")?DateDebut=' + DateDebut + '&DateFin=' + DateFin + '&ClientId=' + IdColt + '&type=HistoClt')
