  ...
  <div class="contentwrapper">
        ...
        <div class="heading">
            ...
            <h3 style="color:#353535">
                <i class="fa fa-archive"></i> Agios Par Client
            </h3>
        </div>
        <!-- End  / heading-->
        <!-- Start .row -->
...
New SelectList(Model.ListeMois, "Value", "Text"), "Selectionnez un mois", New With {.class = "form-control select2 col-md-2"})
...
<script>
    $('#lnkReport').on('click', function () {
        ...
        var Mois = $('#Mois').val();
        var Annee = $('#Annee').val();
        $('#ifrReport').attr('src', '@Url.Content("~/Report/NewReport.aspx")?AgenceId=' + AgenceId + '&Mois=' + Mois +'&Annee='+ Annee + '&type=AgiosParClient')
        });
