  ...
  <div class="contentwrapper">
        ...
        <div class="heading">
            ...
            <h3 style="color:#353535">
                <i class="fa fa-archive"></i> Recette Client
            </h3>
        </div>
        <!-- End  / heading-->
        <!-- Start .row -->
...
<script>
    $('#lnkReport').on('click', function () {
            ...
            $('#ifrReport').attr('src', '@Url.Content("~/Report/NewReport.aspx")?DateDebut=' + DateDebut + '&DateFin=' + DateFin + '&ClientId=' + IdColt + '&type=RecetteClt')
        });
