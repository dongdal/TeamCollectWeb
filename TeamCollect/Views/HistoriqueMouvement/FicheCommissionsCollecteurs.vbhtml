  ...
  <div class="contentwrapper">
        ...
        <div class="heading">
            ...
            <h3 style="color:#353535">
                <i class="fa fa-archive"></i> Fiche Commissions par Collectrice
            </h3>
        </div>
        <!-- End  / heading-->
        <!-- Start .row -->
...
<script>
    $('#lnkReport').on('click', function () {
        ...
        $('#ifrReport').attr('src', '@Url.Content("~/Report/NewReport.aspx")?AgenceId=' + AgenceId + '&Mois=' + Mois + '&Annee=' + Annee + '&type=FicheCommissionsCollecteurs')
        }
