    ...
    <div class="row">
        <div class="panel panel-pattern toggle panelMove panelRefresh">
            ...
            <div class="panel-heading">
                <h4 class="panel-title" style="color:#353535"><i class="fa fa-magic"></i> Formulaire de calcul des commissions mensuelles...</h4>
            </div>
            <div class="panel-body pt0 pb0">
                <div id="wizard" class="bwizard">
                    @Using (Html.BeginForm("CalculCommissionByProc", "CalculAjout", FormMethod.Post, New With {.role = "form"}))
...
New SelectList(Model.ListeAnnee, "Value", "Text"), "Selectionnez une année", New With {.class = "form-control select2"})
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="box-footer" style="text-align:center">
                                            ...
                                            @Html.ActionLink("Retour", "IndexCommission", "CalculAjout", Nothing, New With {.class = "btn btn-default btn-sm"})
                                        </div>
                                    </div>
