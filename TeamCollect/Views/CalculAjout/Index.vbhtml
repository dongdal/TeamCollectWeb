@modelType PagedList.IPagedList(Of HistoriqueCalculAjout)
...
<div class="contentwrapper">
    ...
    <div class="heading">
        ...
        <div style="float:right; color:black">
            <a href="@Url.Action("CreateByProc")" class="btn btn-primary mr5 mb10" style="margin-top: 5px; color:#353535">
                <i class="glyphicon glyphicon-plus mr5"></i> Calculer les Agios Mensuel
            </a>
        </div>
    ...
    <br />
    <div class="row">
        @Using (Html.BeginForm("Index", "CalculAjout", FormMethod.Get, New With {.class = "form-inline", .role = "form"}))
