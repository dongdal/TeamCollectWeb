@modelType PagedList.IPagedList(Of BorneCommission)
...
<div class="contentwrapper">
    ...
    <div class="heading">
        ...
        <div style="float:right; color:black">
            <a href="@Url.Action("Create")" class="btn btn-primary mr5 mb10" style="margin-top: 5px; color:#353535">
                <i class="glyphicon glyphicon-plus mr5"></i> Enregistrer une borne de commission dans le système
            </a>
        </div>
    ...
    <br />
    <div class="row">
        @Using (Html.BeginForm("Index", "BorneCommission", FormMethod.Get, New With {.class = "form-inline", .role = "form"}))
        ...
        <table class="table table-bordered table-striped table-hover dt-responsive table-responsive" cellspacing="0" width="100%">
            ...
            <tbody>
                ...
                @For Each item In Model
                    @<tr>
    <td>
        @Html.DisplayFor(Function(modelItem) item.BornInf)
    </td>
    <td>
        @Html.DisplayFor(Function(modelItem) item.BornSup)
    </td>
