...
@Code
    ViewData("Title") = Resource.CategorieRemunerationDetail
End Code
    ...
    <div class="row">
        <div class="panel panel-pattern toggle panelMove panelRefresh">
            ...
            <div class="panel-heading">
                <h4 class="panel-title" style="color:#353535"><i class="fa fa-magic"></i> @Resource.CategorieRemunerationDetail</h4>
            </div>
                    ...
                    <div class="box box-warning">
                        <div class="box-header with-border">
                            ...
                            <div class="box-footer" style="text-align:center">
                                ...
                                @Html.ActionLink(Resource.Btn_Edit, "Edit", New With {.id = Model.Id}, New With {.class = "btn btn-primary btn-sm"})
