...
(function($) {
    ...
    $.supr = function(element, options) {
        ...
        plugin.setCurrentNav = function () {
            ...
            if(domain === '') {
                //domain not found
                var pageUrl = window.location.pathname.split( 'http://demos.getbootstrapkit.com/' );
                ...
                if(plugin.settings.sideNav.absoluteUrl) {
                    ...
                    var afterDomain = window.location.pathname.split( 'http://demos.getbootstrapkit.com/' );
